...
fun LedControlScreen(
    ...
    LedControlContent(
        ...
        setLedEffect = viewModel::setLedEffect,
        setEffectCycle = viewModel::setEffectCycle,
        addFavEffect = viewModel::addFavEffect,
        removeFavEffect = viewModel::removeFavEffect,
        ...
        onChangeWhiteBrightness = viewModel::changeWhiteLedBrightness,
        onSetEffectSpeed = viewModel::setEffectSpeed,
